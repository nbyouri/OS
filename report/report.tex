...
\chapter{Conclusion}
	...
	\section{Solutions apportées aux problèmes}
		...
		\subsection{Lecture et écrite sur meteo.txt}
			...
			Au niveau de la lecture, nous avions également un problème avec un tableau statique de pointeurs, où la lecture était effectuée d'office sur 8 bytes de part la nature même d'un tableau. Ce problème a été résolu via l'utilisation d'un tableau statique à deux dimensions.
