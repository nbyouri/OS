...
\chapter{Détails et éléments techniques spécifiques}
	...
	\section{Makefile et configure}
		...
		\subsection{Configure}
			...
			Afin de pouvoir porter ce programme sur tout système d'exploitation basé UNIX, un programme configure a été réalisé.
			Celui-ci, à lancer avant le Make, effectue une batterie de 
