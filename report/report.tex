...
\chapter{Analyse}
 \section{Plan de l'application}
	...
	Ces trois programmes vont se servir d' \og outils \fg fonctionnalisés dans le fichier {\textbf{\color{red} tools.c}} et obtenir les librairies, déclarations de fonctions et constantes via le fichier {\textbf{\color{black} global.h}}.
